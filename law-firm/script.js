/* Hutchinson & Stamell — interactions */
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (parallaxImgs.length) {
    ...
    const onScrollPx = () => { if (!ticking) { requestAnimationFrame(update); ticking = true; } };
    update();
  ...
  document.querySelectorAll('form[data-newsletter]').forEach(form => {
    form.addEventListener('submit', (e) => {
      ...
      const msg = encodeURIComponent(`Halo Hutchinson & Stamell, mohon kirimkan surat pengetahuan hukum ke email: ${email}`);
